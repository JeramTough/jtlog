...
public @interface LogConfiguration {
     ...
     * 关于全局默认值见日志配置默认值接口{@link com.jeramtough.jtlog.config.LogConfigDefaultValues}
     * </p>
     * @return 返回值小于0使用全局默认值，返回值0表示不换行, 返回值大于0 表示超过这个值就会换行
     */
     ...
     * 关于全局默认值见日志配置默认值接口{@link com.jeramtough.jtlog.config.LogConfigDefaultValues}
     * </p>
     * @return 返回LogLevel.DEFAULT使用全局默认值
     */
     ...
     * 关于全局默认值见日志配置默认值接口{@link com.jeramtough.jtlog.config.LogConfigDefaultValues}
     * </p>
     * @return 返回{ LogHeader.DEFAULT }使用全局默认值
     */
     ...
     * 关于全局默认值见日志配置默认值接口{@link com.jeramtough.jtlog.config.LogConfigDefaultValues}
     * </p>
     * @return 返回值小于0使用全局默认值，返回值0表示两条日志间无空行, 返回值大于0 表示两条日志间有n条空行
     */
     ...
     * @return  * @return class implement {@link LogRecorder}
     */
     ...
     * 关于全局默认值见日志配置默认值接口{@link com.jeramtough.jtlog.config.LogConfigDefaultValues}
     * </p>
     * @return 返回"default"使用全局默认值,返回时间格式则使用该格式
     */
