 ...
 */
public class DefaultLogConfigFactory implements LogConfigFactory {

    private final LogConfigDefaultValues logConfigDefaultValues;

    public DefaultLogConfigFactory(
    ...
    public LogConfig getLogConfigByAnnotation(String contextName,
        ...
        LogConfig logConfig = new LogConfig();
        LogConfiguration logConfiguration = classWithLogConfigerAnnotation.getAnnotation(LogConfiguration.class);
